                        ...
                        <section id="mypageinfo">
                           ...
                           <section style="display: flex; justify-content: space-between; align-items: center;" class="info">
                              ...
                              <div id="updatePasswordModal" class="modal">
                                 <div class="modal-content">
                                    <form action="updateMemberPW.do" method="post">
                                       <span class="close">&times;</span> <label style="font-size: 25px;">비밀번호 변경</label> 
                                       <input style="width: 100%" name="memberPW" id="passwordUdate" type="password" placeholder="변경할 비밀번호 입력">
                              ...
                              <div id="updateNicknameModal" class="modal">
                                 <div class="modal-content">
                                    <form action="updateNickName.do" method="post">
                                       ...
                                       <input style="width: 100%" name="nickName" type="text" placeholder="변경할 닉네임 입력">
                                       <button type="submit">확인</button>
                                    </form>
                                 </div>
                              </div>
                           ...
                           <section style="display: flex; width: 100%;" class="info">
                              ...
                              <form action="updateAddress.do" method="post" style="width: 100%">
