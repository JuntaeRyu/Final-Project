								...
								<section id="mypageinfo">
										...
										<div id="updatePasswordModal" class="modal">
											<div class="modal-content">
												<form action=".do" method="post">
													<span class="close">&times;</span> <label style="font-size: 25px;">비밀번호 변경</label> <input style="width: 100%" name="memberPW" id="passwordUdate" type="password" placeholder="변경할 비밀번호 입력">
									...
									<section style="display: flex; justify-content: space-between; align-items: center;" class="info">
										...
										<div id="updateNicknameModal" class="modal">
											<div class="modal-content">
												<form action=".do" method="post">
													<span class="close">&times;</span> <label style="font-size: 25px;">닉네임 변경</label> <input style="width: 100%" name="nickName" id="nicknameUdate" type="text" placeholder="변경할 닉네임 입력">
													<button type="submit">확인</button>
												</form>
											</div>
										</div>
									...
									<section style="display: flex; justify-content: space-between; align-items: center;" class="info">
										...
										<div id="updateEmailModal" class="modal">
											<div class="modal-content">
												<form action=".do" method="post">
													<span class="close">&times;</span> <label style="font-size: 25px;">이메일 변경</label> <input style="width: 100%" name="email" id="emailUdate" type="text" placeholder="변경할 이메일 입력">
													<button type="submit">확인</button>
												</form>
											</div>
										</div>
									...
									<h3>주소</h3>
									<section class="info" style="height: 180px;">
										<h1>${mdata.address}</h1>

										<div class="verification-container">
											<button onclick="sample6_execDaumPostcode()" style="width: 20%; display: block; margin-bottom: 5px;">우편번호 찾기</button>
											<input type="text" id="sample6_address" placeholder=" 주소">
										</div>
										<div class="verification-container">
											<input type="text" id="sample6_extraAddress" name="address" placeholder=" 상세주소"> 
										</div>
											<input id="updateBtn5" style="display: block; margin-left: auto; position: relative; top: -60px;" type="submit" value="수정">
