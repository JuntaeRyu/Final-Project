			...
			<!-- Header -->
				<header id="header">
					<div class="logo container">
						<div>
							<h1><a href="main.do" id="logo">정보 변경</a></h1>
							<p></p>
						</div>
					</div>
				</header>
        ...
        <ul>
          <nav id="nav1">
            ...
            <li>
              ...
              <ul>
                ...
                <li><a href="infoBoradListPage.do">정보</a></li>
                <li><a href="chatBoardList.do">잡담</a></li>
              </ul>
            </li>
            <li>
          ...
          <c:choose>
            <c:when test="${empty mid}">
              <a href="loginPage.do" class="icon solid fa-lock login" value="로그인" title="로그인" ></a>
              <a href="signupPage.do" class="icon solid fa-user-plus signup" value="회원가입" title="회원가입" ></a>
            </c:when>
            <c:otherwise>
              <a href="logout.do" class="icon solid fa-lock-open logout" value="로그아웃" title="로그아웃" ></a>
              <a href="mypage.do" class="icon solid fa-user mypage" value="마이페이지" title="마이페이지" ></a>
            </c:otherwise>
          </c:choose>
        </ul>
      </nav>
							...
							<div class="col-3 col-12-medium">
								<div class="sidebar">
									...
									<!-- Sidebar -->
										...
										<!-- Recent Posts -->
											<section>
												<h2 class="major"><span>사용 목록</span></h2>
												<ul class="divided">
													<li>
														<article class="box post-summary">
															<h3><a href="boardList.do">내가 작성한 글목록</a></h3>
														</article>
													</li>
													<li>
														<article class="box post-summary">
															<h3><a href="#">프로필 변경</a></h3>
														</article>
													</li>
													<li>
														<article class="box post-summary">
															<h3><a href="updateMember.do">정보 변경</a></h3>
														</article>
													</li>
													<li>
														<article class="box post-summary">
                                 ...
                                 <section id="mypageinfo">
                                    ...
                                    <section style="display: flex; justify-content: space-between; align-items: center;" class="info">
                                       ...
                                       <div id="updatePasswordModal" class="modal">
											<div class="modal-content">
												<span class="close">&times;</span>
												<label style="font-size: 25px;">비밀번호 변경</label>
												<form action=".do" method="post">
													<input name="mpw" id="passwordUdate" type="password" placeholder="변경할 비밀번호 입력">
                                    ...
                                    <section style="display: flex; justify-content: space-between; align-items: center;" class="info">
                                       ...
                                       <h1>${bdata.nickname}</h1>
                                    	...
                                    	<div id="updateNicknameModal" class="modal">
											<div class="modal-content">
												<span class="close">&times;</span>
												<label style="font-size: 25px;">닉네임 변경</label>
												<form action=".do" method="post">
												<input name="nickname" id="nicknameUdate" type="text" placeholder="변경할 닉네임 입력">
												<button type="submit">확인</button>
												</form>
											</div>
									   </div>
                                      ...
                                      <section style="display: flex; justify-content: space-between; align-items: center;" class="info">
                                       ...
                                       <div id="updatePhoneModal" class="modal">
											<div class="modal-content">
												<span class="close">&times;</span>
												<label style="font-size: 25px;">핸드폰번호 변경</label>
												<form action=".do" method="post">
												<input name="phone" id="phoneUdate" type="text" placeholder="변경할 핸드폰번호 입력">
												<button type="submit">확인</button>
												</form>
											</div>
									   </div>
                                       
                                       		<input id="updateBtn3" style="display: block; margin-left: auto;" type="submit" value="수정">
                                    </section>
                                    ...
                                    <section style="display: flex; justify-content: space-between; align-items: center;" class="info">
                                       ...
                                       <div id="updateEmailModal" class="modal">
											<div class="modal-content">
												<span class="close">&times;</span>
												<label style="font-size: 25px;">이메일 변경</label>
												<form action=".do" method="post">
												<input name="email" id="emailUdate" type="text" placeholder="변경할 이메일 입력">
												<button type="submit">확인</button>
												</form>
											</div>
									   </div>
                                     ...
                                     <section style="display: flex; justify-content: space-between; align-items: center;" class="info">
                                       ...
                                       <div id="updateAddressModal" class="modal">
											<div class="modal-content">
												<span class="close">&times;</span>
												<label style="font-size: 25px;">주소 변경</label>
												<form action=".do" method="post">
												<input name="address" id="addressUdate" type="text" placeholder="변경할 주소 입력">
												<button type="submit">확인</button>
												</form>
											</div>
									   </div>
                                       
                                       		<input id="updateBtn5" style="display: block; margin-left: auto;" type="submit" value="수정">
                                    </section>
                                 </section>
	                                 ...
	                                 <section id="mypageintroduction">
    	                                ...
    	                                <div id="updateTextModal" class="modal">
											<div class="modal-content">
												<span class="close">&times;</span>
												<label style="font-size: 25px;" for="password">소개글 변경</label>
												<form action=".do" method="post">
                                       		...
                                       		<input id="updateBtn6" style="display:fix; margin-left: 82.5%;" type="submit" value="수정">
        	                            <textarea style="margin-top: 10px;">${bdata.text}</textarea>
            	                     </section>
