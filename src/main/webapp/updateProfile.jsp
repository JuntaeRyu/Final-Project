			...
			<!-- Header -->
				<header id="header">
					<div class="logo container">
						<div>
							<h1><a href="main.do" id="logo">프로필 변경</a></h1>
							<p></p>
						</div>
					</div>
				</header>
                                 ...
                                 <section id="mypageprofile">
    								<h2 style="color: #bead7c;">프로필</h2>
    									<div class="imageContainer">
        										<img class="centered-image" src="assets/css/images/log.png.jpg" alt="" />
